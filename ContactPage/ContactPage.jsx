...
export const ContactPage = () => {
  return (
    ...
    text-slate-950 '>
      <header className="w-full py-6  border-l border-r border-[#3e3e3e]">
        <h2 className="text-5xl text-gray-300 pb-8 pl-8 border-b border-[#3e3e3e]">Kontakt</h2>
      </header>
     <div className="content-wrapper flex h-full">
      <div className="w-1/2 h-full flex-1 border-r border-[#3e3e3e] ">
        <Left />
      </div>
      <div className="w-1/2 h-full flex-1"></div>
     </div>
    </div>
    </div>
  )
